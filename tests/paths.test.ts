...
describe("HarmonicPath catalog invariants", () => {
  it("PATHS, STUDIES_PATHS, COMPOSER_PATHS, SECTION_PATHS, and ALL_PATHS are all defined", () => {
    expect(Array.isArray(PATHS)).toBe(true);
    expect(Array.isArray(STUDIES_PATHS)).toBe(true);
    expect(Array.isArray(COMPOSER_PATHS)).toBe(true);
    expect(Array.isArray(SECTION_PATHS)).toBe(true);
    expect(Array.isArray(ALL_PATHS)).toBe(true);
  });

  it("ALL_PATHS is PATHS + STUDIES_PATHS + COMPOSER_PATHS + SECTION_PATHS", () => {
