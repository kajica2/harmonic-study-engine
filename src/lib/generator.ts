...
const INTERMEDIATE_CHORDS = [
  ...
  { name: "G13", notes: [43, 53, 59, 64, 69], desc: "Dominant 13th." },
  {
    ...
    desc: "Modal interchange flat III.",
  },
  {
    name: "A7(b9)",
    notes: [45, 55, 61, 64, 66],
    desc: "Secondary dominant with tension.",
  },
  {
    name: "Bbmaj7",
    notes: [46, 53, 57, 62],
    desc: "Modal interchange flat VII.",
  },
...
const ADVANCED_CHORDS = [
  {
    name: "Db13(#11)",
    notes: [49, 59, 63, 67, 70],
    desc: "Lydian dominant tritone sub.",
  },
  { name: "Cmaj7(#5)", notes: [48, 52, 56, 59], desc: "Augmented major." },
  {
    name: "Gbmaj9(#11)",
    notes: [54, 61, 65, 70, 72],
    desc: "Bright lydian color.",
  },
  {
    name: "B7(b9 b13)",
    notes: [47, 57, 63, 66, 71],
    desc: "Fully altered dominant.",
  },
  { name: "Ebm11", notes: [51, 54, 61, 63, 68], desc: "Dark floating minor." },
  {
    name: "Ab13(b9)",
    notes: [44, 54, 60, 65, 69],
    desc: "Tense chromatic dominant.",
  },
  {
    name: "F#m7(b5)",
    notes: [54, 57, 60, 64],
    desc: "Half-diminished tension.",
  },
];

export function generateHarmonicPath(
  lengthLevel: number,
  ...
  const endChord =
    complexityLevel === 3
      ? INTERMEDIATE_CHORDS[0]
      : BASIC_CHORDS[BASIC_CHORDS.length - 1];
  steps.push({
    name: endChord.name,
