/**
 * src/lib/chordInput.ts - PRD-001 Phase 4 Slice 2 (D61).
 *
 * The chord-cell popover's symbol grammar: a PURE round-trip between a
 * typed chord symbol ("Cm7", "Ebmaj7", "G7/B") and the engine's
 ...
 * that would silently degrade into a different cell.
 *
 ...
 * ASCII; ""->maj, "m"->min).
 *
 * Purity: no DOM, no clock, no randomness, no console. suggestChord-
 * Symbols takes recents as an ARGUMENT (the recent-edit buffer lives
 * in the surface, not here) so this module stays pure.
 */
