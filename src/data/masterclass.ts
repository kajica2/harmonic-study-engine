...
export const MASTERCLASS_TUNES: MasterclassEntry[] = [
  ...
  { id: "is-you-is-or-is-you-aint", title: "Is You Is or Is You Ain't My Baby", classes: ["MC 3", "MC 5"],
    ...
    inApp: false },
  { id: "study-yardbird-suite", title: "Yardbird Suite", classes: ["MC 4", "MC 19"],
  ...
  { id: "study-there-will-never-be-another-you", title: "There Will Never Be Another You", classes: ["MC 23", "MC 24", "MC 32"],
    ...
    inApp: true },
  { id: "study-out-of-nowhere", title: "Out of Nowhere", classes: ["MC 25", "MC 26", "MC 27", "MC 28"],
    ...
    objective: "Sing the 3-to-9 road map through the form — 5-♯9 line cliché over the diminished trail.",
    inApp: true },
  { id: "study-nostalgia-in-october", title: "Nostalgia in October", classes: ["MC 29", "MC 30", "MC 31"],
    ...
    objective: "Improvise on each event — play 'the minimum' — and run the 5-to-1 scale exercise in the important minor.",
    inApp: true },
  { id: "study-ill-remember-april", title: "I'll Remember April", classes: ["MC 35", "MC 38", "MC 39"],
    ...
    objective: "Learn the bridge by interval — 3 minor-3rd keys — and sing it in every key.",
    inApp: true },
  { id: "study-groovin-high", title: "Groovin' High", classes: ["MC 36"],
    ...
    objective: "Sing 2-bar 2-5-1 diatonic phrases in every key — chromatic, then minor thirds, then other intervals.",
    inApp: true },
  { id: "study-hot-house", title: "Hot House", classes: ["MC 10", "MC 11", "MC 12"],
    ...
    objective: "Scat Hot House against What Is This Thing Called Love — lock the double-time pocket phrasing.",
    inApp: true },
  { id: "study-confirmation", title: "Confirmation", classes: ["MC 34"],
    ...
    objective: "Analyze the great Confirmation solo — name every chord tone and non-chord tone.",
    inApp: true },
